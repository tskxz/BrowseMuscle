...
module.exports = {
	...
	visualizarTodos: () => {
		return new Promise( (aceito, rejeitado) =>{
			db.query('SELECT Marcas.nome as marca, alimentos.id as id, alimentos.nome as nome, alimentos.proteina as proteina, alimentos.carbs as carbs, alimentos.gordura as gordura, alimentos.calorias as calorias, alimentos.id_marca FROM alimentos JOIN Marcas ON alimentos.id_marca', (error, results) => {
