...
module.exports = {
  ...
  main: async (req, res) => {
    ...
    res.render("admin/Utilizadores/Utilizadores.hbs", {
  ...
  perfil: async (req, res) => {
    ...
    if (utilizador) {
      res.render("app/utilizador/perfil_user", {
        ...
        descricao: utilizador.descricao,
        treinos_concluidos: utilizador.treinos_concluidos,
        createdAt: utilizador.createdAt.toLocaleDateString("pt-PT", {
          year: "numeric",
          month: "2-digit",
          day: "2-digit",
        }),
  ...
  atualizar_perfil: async (req, res) => {
    ...
    let utilizador = await UtilizadorService.alterar(
      id,
      primeiro_nome,
      ultimo_nome,
      email,
  ...
  atualizar_perfil_foto: async (req, res) => {
    ...
    sampleFile.mv(uploadPath, async function (err) {
      ...
      let utilizador = await UtilizadorService.alterar_foto(
        id,
        sampleFile.name
      );
      if (utilizador) {
  ...
  // Página Administração - Pesquisar Utilizador
